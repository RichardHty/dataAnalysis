...
#aov:groups exists within a category
...
n2 = 60
p0 = 0.8
prop.test(s1,n1,p=0.8,conf.level=0.95, correct=TRUE)
...
p2 = s2/n2
p = (s1+s2)/(n1+n2)
prop.test(s_data,c_data, alternative='two.sided', 
          conf.level=0.95, correct=TRUE)
#p2 is reference group
risk_difference<- p1 - p2
risk_ratio<-p1/p2
odd_ratio <- (p1/(1-p1))/(p2/(1-p2))
se_p<-sqrt(p1*(1-p1)/n)
two_sample_se_p<-sqrt(p1*(1-p1)/n1+p2*(1-p2)/n2)

one_sample_z_value <- p1-p0/sqrt(p0*(1-p0)/n)
z_value<-(p1-p2)/(sqrt(p*(1-p)*(1/n1+1/n2)))

conf_up<-risk_difference+qnorm(0.975)*two_sample_se_p
